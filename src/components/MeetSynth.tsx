...
export default function MeetSynth() {
  ...
  return (
    <section ref={ref} className="relative bg-[#080812] py-32 overflow-hidden" id="features">
      {/* Background pattern */}
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div className="relative h-full p-8 rounded-3xl bg-[#11111B]/80 border border-[#8B5CF6]/10 hover:border-[#8B5CF6]/40 transition-all duration-300 overflow-hidden">
