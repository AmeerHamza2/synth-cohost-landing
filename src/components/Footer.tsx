  ...
  const accordionSections = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Instagram', href: 'https://instagram.com/synthcohost' },
      ]
    },
  ];
      ...
      <div className="md:hidden px-6 pt-8 pb-6">
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <div className="text-center">
            <span className="block text-[26px] font-bold tracking-[3px] text-white">SYNTH</span>
            <span className="block text-[26px] font-bold tracking-[3px] text-white">COHOST</span>
          </div>
        </div>
