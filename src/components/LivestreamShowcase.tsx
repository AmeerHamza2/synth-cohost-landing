...
export default function LivestreamShowcase() {
  ...
  return (
    <section ref={ref} className="relative bg-[#080812] py-32 overflow-hidden" id="product">
      <div className="absolute inset-0 bg-gradient-to-b from-[#080812] to-[#0a0a18]" />
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative rounded-2xl overflow-hidden border border-[#8B5CF6]/30 glow-purple bg-[#11111B]">
              {/* Video Player Area */}
              ...
              <div className="grid grid-cols-2 divide-x divide-[#8B5CF6]/10">
                {/* Chat Panel */}
                <div className="p-4">
